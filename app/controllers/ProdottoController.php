...
class ProdottoController
{
    ...
    ");
        ...
        ");
            ...
            // Prelievo immagine scheda tecnica
            $stmt_scheda_tecnica = $pdo->prepare("
            SELECT i.articolo_id immagine_articolo_id, i.id immagine_id, i.slug immagine_slug, i.link immagine_link, i.alt_it immagine_alt_it, i.alt_en immagine_alt_en, i.tipologia_immagine_id
            FROM immagine i
            WHERE i.articolo_id = ?
            AND i.tipologia_immagine_id = 6
            LIMIT 1
        ");
            $stmt_scheda_tecnica->execute([$id]);
            $scheda_tecnica = $stmt_scheda_tecnica->fetch(\PDO::FETCH_ASSOC);
        ...
        ");
            ...
            $data["scheda_tecnica"] = $scheda_tecnica;
